...
## Acceptance Criteria
- [x] Sidebar is visually collapsed when page first loads
- [x] Sidebar toggle button in header remains visible and functional
- [x] Clicking toggle button opens the sidebar as expected
- [x] Closing and reopening the sidebar still works correctly
- [x] On mobile/tablet (responsive view), sidebar remains closed by default
- [x] No JavaScript errors in console related to sidebar initialization
